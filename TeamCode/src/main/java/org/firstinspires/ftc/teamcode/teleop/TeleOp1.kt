...
import org.firstinspires.ftc.teamcode.subsystems.Arm.States.BACKHIGH
...
class TeleOp1 : LinearOpMode() {
    ...
    override fun runOpMode() {
        ...
        EventLoop(::opModeIsActive).apply {
            ...
            onPressed(gp1::x, gp2::x) { arm.state = MID }
            onPressed(gp1::y, gp2::y) { arm.state = HIGH }
            onPressed(gp1::b, gp2::b) { arm.state = BACKHIGH }
        }.also {
            waitForStart()
            it.run()
        }
